        ...
        <div className="relative z-10">
          ...
          <div className="space-y-4 text-zinc-300">
            <p>
              ...
              German Minecraft CityBuild network that provides players with an
              exceptional CityBuild experience. Our server feature
              custom-designed gameplay mechanics, unique items, and a thriving
              community.
            </p>
            <p>
              Whether you&apos;re a casual player or a more professional player,
              CuteCraft offers something for everyone community events, and
              active German-speaking playerbase.
            </p>
          </div>
        </div>
      </div>
